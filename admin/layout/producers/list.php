...
<div class="menu-content">
  <div class="search-container">
    <form action="" method="POST" style="height: 40px;" class="form-search">
      <a href="<?=URL.'/producers/create'?>" class="btn btn-green btn-create">Create new</a>
    </form>
  </div>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td class="action">
            <a href="<?=URL.'/producers/detail/'.$producer['id']?>"><button class="btn btn-edit">
                <i class="fas fa-edit"></i></button></a>
            <a onclick="getModalConfirm('<?=URL.'/producers/delete/'.$producer['id']?>')" class="btn-delete-product"><button class="btn btn-delete">
  ...
  <div>
    ...
    <ul class="paginate">
      ...
      <li>
        <a href="<?=$href = URL.'/producers/list/'.$i?>"><span class="page-number <?=$currentPage == $i?'choose':''?>"><?=$i?></span></a>
      </li>
      <?php
      }
      $href = 'javascript:void(0)';
