<div class="menu-content">
  <div class="search-container">
    <form action="" method="POST" class="d-flex form-search">
      ...
      <a href="<?=URL.'/admins-management/list'?>" class=""><i class="fas fa-sync"></i></a>
      <a href="<?=URL.'/admins-management/create'?>" class="btn btn-green btn-create">Create new</a>
    </form>
  </div>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td class="action">
            <a href="<?=URL.'/admins-management/detail/'.$admin['id']?>"><button class="btn btn-edit">
                <i class="fas fa-edit"></i></button></a>
            <?php
              if($_SESSION['user']['id'] == 1){
            ?>
              <a onclick="getModalConfirm('<?=URL.'/admins-management/delete/'.$admin['id']?>')" class="btn-delete-admin"><button class="btn btn-delete">
  ...
  <div>
    ...
    <ul class="paginate">
      ...
      {
        $page = $currentPage - 1;
        $href = URL.'/admins-management/list/'.$page;
      }
      ?>
      <li>
      ...
      <li>
        <a href="<?=$href = URL.'/admins-management/list/'.$i?>"><span class="page-number <?=$currentPage == $i?'choose':''?>"><?=$i?></span></a>
      </li>
      <?php
      }
      $href = 'javascript:void(0)';
