  ...
  ?>
      <div class="block-order">
        ...
        <div class="order-action">
          <a href="<?= URL . '/orders/process-confirm/deny/' . $order['id'] ?>" class="btn btn-red">Từ chối</a>
          <a href="<?= URL . '/orders/process-confirm/accept/' . $order['id'] ?>" class="btn btn-green">Xác nhận</a>
        </div>
      </div>
  <?php
    endforeach;
