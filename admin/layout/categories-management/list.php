...
<div class="menu-content">
  <div class="search-container">
    <form action="" method="POST" style="height: 40px;" class="form-search">
      <a href="<?=URL.'/categories-management/create'?>" class="btn btn-green btn-create">Create new</a>
    </form>
  </div>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td class="action">
            <a href="<?=URL.'/categories-management/detail/'.$category['id']?>"><button class="btn btn-edit">
                <i class="fas fa-edit"></i></button></a>
            <a onclick="getModalConfirm('<?=URL.'/categories-management/delete/'.$category['id']?>')" class="btn-delete-product"><button class="btn btn-delete">
  ...
  <div>
    ...
    <ul class="paginate">
      ...
      {
        $page = $currentPage - 1;
        $href = URL.'/categories-management/list/'.$page;
      }
      ?>
      <li>
      ...
      <li>
        <a href="<?=$href = URL.'/categories-management/list/'.$i?>"><span class="page-number <?=$currentPage == $i?'choose':''?>"><?=$i?></span></a>
      </li>
      <?php
      }
      $href = 'javascript:void(0)';
