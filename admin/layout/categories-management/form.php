    ...
    <div class="d-flex">
      <div class="col-6 form-left-content">
        <div class="d-flex form-control">
          ...
          <input class="col-9 input-form" value="<?=$category['name']??''?>" name="name" id="form-control-1" type="text">
        </div>

        <div class="d-flex form-control">
          <label class="col-3 form-label" for="form-control-5">Description</label>
          <textarea name="description" id="form-control-5" rows="6" class="col-9 form-text form-label"><?=$category['description']??''?></textarea>
        </div>
      ...
      <div class="col-6 form-right-content form-control">
        ...
        <div>
          ...
          <input id="input-image" value="<?=$category['avatar']??''?>" name="image" type="file" accept="image/*">
        </div>
        <div>
          <label for="input-image"><img src="<?= asset($category['avatar']??'assets/img/no-image.png') ?>" id="preview-image" class="preview-image" alt=""></label>
        </div>
      </div>
    </div>
    <div class="d-flex form-button col-12">
      <button type="reset" onclick="redirect(`http://localhost/DeTai/admin/categories-management/list`)" class="btn btn-close btn-gray">Close</button>
