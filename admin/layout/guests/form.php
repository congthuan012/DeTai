...
<div class="menu-content">
  ...
  <form action="<?= $action ?? '' ?>" id="form-guest" method="POST" enctype="multipart/form-data">
    <div class="d-flex">
      <div class="col-6 form-left-content">
        <div class="d-flex form-control">
          <label class="col-3 form-label" for="form-control-1">Name</label>
          <input class="col-9 input-form" value="<?=$guest['name']??''?>" name="name" id="form-control-1" type="text">
        </div>
        <div class="d-flex">
        ...
        <div class="d-flex form-control">
          ...
          <input class="col-9 input-form" name="username" value="<?=$guest['username']??''?>" id="form-control-2" type="text">
        </div>
        <div class="d-flex">
          <label class="col-3 form-label" for="form-control-1"></label>
        ...
        <div class="d-flex form-control">
          ...
          <label class="d-flex align-items-center col-3 form-label"><input name="status" <?= isset($guest['status']) && $guest['status']==1?'checked':''?> type="checkbox" value="1">Active</label>
        </div>

        <div class="d-flex form-control">
          <label class="col-3 form-label" for="form-control-5">Address</label>
          <textarea name="address" id="form-control-5" rows="6" class="col-9 form-text form-label"><?=$guest['address']??''?></textarea>
        </div>
      ...
      <div class="col-6 form-right-content form-control">
        ...
        <div>
          ...
          <input id="input-image" value="<?=$guest['avatar']??''?>" name="image" type="file" accept="image/*">
        </div>
        <div>
          <label for="input-image"><img src="<?= asset($guest['avatar']??'assets/img/no-image.png') ?>" id="preview-image" class="preview-image" alt=""></label>
        </div>
      </div>
    </div>
    <div class="d-flex form-button col-12">
      <button type="reset" onclick="redirect(`http://localhost/DeTai/guest/guests/list`)" class="btn btn-close btn-gray">Close</button>
