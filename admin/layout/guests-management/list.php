<div class="menu-content">
  <div class="search-container">
    <form action="" method="POST" class="d-flex form-search">
      ...
      <a href="<?=URL.'/guests-management/list'?>" class=""><i class="fas fa-sync"></i></a>
      <a href="<?=URL.'/guests-management/create'?>" class="btn btn-green btn-create">Create new</a>
    </form>
  </div>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td class="action">
            <a href="<?=URL.'/guests-management/detail/'.$guest['id']?>"><button class="btn btn-edit">
                <i class="fas fa-edit"></i></button></a>
            <a onclick="getModalConfirm('<?=URL.'/guests-management/delete/'.$guest['id']?>')" class="btn-delete-guest"><button class="btn btn-delete">
  ...
  <div>
    ...
    <ul class="paginate">
      ...
      {
        $page = $currentPage - 1;
        $href = URL.'/guests-management/list/'.$page;
      }
      ?>
      <li>
      ...
      <li>
        <a href="<?=$href = URL.'/guests-management/list/'.$i?>"><span class="page-number <?=$currentPage == $i?'choose':''?>"><?=$i?></span></a>
      </li>
      <?php
      }
      $href = 'javascript:void(0)';
