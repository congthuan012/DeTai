...
$pdo = connectDb();
$sql = 'SELECT * FROM orders WHERE `status` = ? and deleted_at is NULL ORDER BY created_at ASC';
$res = loadRows($pdo,$sql,[1]);
if($res['code'] == 500){
    redirect('orders-management/list',[
        'code' => 500,
        'msg'  => 'Server error!'
    ]);
    exit;
...
require_once './layout/orders-management/confirm.php';